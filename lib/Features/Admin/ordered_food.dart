...
import 'package:orderease/Features/Admin/add_food.dart';
import 'package:orderease/Provider/user_provider.dart';
import 'package:orderease/Widgets/custom_button.dart';
...
class _OrderedFoodState extends State<OrderedFood> {
  ...
  Future<void> _deleteItem(String foodId) async {
    ...
    final url = Uri.parse('${GlobalVariables.baseUrl}/admin/delete-ordered-item/$foodId');
